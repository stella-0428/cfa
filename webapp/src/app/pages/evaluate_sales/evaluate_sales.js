...
@observer
class EvaluateSales extends Component {
  ...
  isValidToken = async () => {
    ...
    await networkService.get(url).then((response) => {
      ...
      toast.success("Welcome to Evaluate Sales screen.");
    })
      .catch((error) => {
        console.log(error);
  ...
  render() {
    ...
    return (
      <h2>Welcome to Evaluate Sales screen.</h2>
    );
  }
}


export default EvaluateSales;
